...
const plans = {
  young: {
    title: "Young Pets",
    range: "0–1.5 years",
    features: ["Vaccinations", "Deworming", "Yearly blood panels", "Tele-consults"]
  },
  adult: {
    title: "Adult Pets",
    range: "2–7 years",
    features: ["Routine diagnostics", "Wellness exams", "Parasite control", "Booster vaccines"]
  },
  senior: {
    title: "Senior Pets",
    range: "7+ years",
    features: ["Advanced bloodwork", "Renal & liver monitoring", "Thyroid screening", "Cancer markers"]
  }
};
...
export const Plans: React.FC = () => {
  return (
    <section id="plans" className="py-0 bg-white relative">
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            {Object.entries(plans).map(([key, plan]) => (
                                <div key={key} className="bg-white/80 backdrop-blur-sm p-6 rounded-xl border border-orange-100 hover:border-orange-300 transition-colors shadow-sm">
            ...
            <div className="relative overflow-hidden group border-l border-gray-100">
                 ...
                 <div className="relative z-10 p-12 md:p-24 flex flex-col h-full justify-center">
                    ...
                    >
                        ...
                        <div className="space-y-6">
                             {Object.entries(plans).map(([key, plan]) => (
                                <div key={key} className="bg-white/80 backdrop-blur-sm p-6 rounded-xl border border-blue-100 hover:border-blue-300 transition-colors shadow-sm">
                                    <div className="flex justify-between items-center mb-2">
                                        <h4 className="font-bold text-gray-900">{plan.title}</h4>
        ...
        {/* Unified Banner */}
        <div className="bg-gray-900 py-4 text-center text-white text-sm font-medium relative z-20">
